...
function Counter() {
    ...
    const social = () =>{
        if(socialcount % 5 === 0 || socialcount === 0){
            window.open('https://www.linkedin.com/in/sikha-kumari-8a19a21b8/', '_blank');
            setTimeout(() => {
                window.open('https://github.com/sikha22/', '_blank');
            }, 2000);
        }
        socialcount +=1;
    }
  ...
  return (
    <div className='main'>
        ...
        <p onMouseOver={social} className='credit'>Done by <span> </span></p>
    </div>
  );    
}
